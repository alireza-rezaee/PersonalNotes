...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.ACategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.ArticleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.SCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.ShareCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.ArticleCategory", b =>
                {
                    b.HasOne("Rezaee.Alireza.Web.Models.Article", "Article")
                        .WithMany("ArticleCategories")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rezaee.Alireza.Web.Models.ACategory", "Category")
                        .WithMany("ArticleCategories")
            ...
            modelBuilder.Entity("Rezaee.Alireza.Web.Models.ShareCategory", b =>
                {
                    ...
                    b.HasOne("Rezaee.Alireza.Web.Models.SCategory", null)
                        .WithMany("ShareCategories")
                        .HasForeignKey("SCategoryId");

                    b.HasOne("Rezaee.Alireza.Web.Models.Share", null)
                        .WithMany("ShareCategories")
