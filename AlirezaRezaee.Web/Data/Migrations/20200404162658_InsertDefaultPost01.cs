...
{
    public partial class InsertDefaultPost01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"INSERT INTO[Articles]([Title], [PublishDateTime], [LatestUpdateDateTime], [HtmlContent], [SourcesUrl], [CoverUrl], [Summary], [ThumbnailUrl], [UrlTitle]) VALUES
                    (N'سلام بر مهدی عج',
                    '2020-04-05',
                    NULL,
                ...
                INSERT INTO[Shares]([Title], [PublishDateTime], [LatestUpdateDateTime], [Url], [Summary], [ThumbnailUrl], [UrlTitle]) VALUES
                    (N'سامانه غربالگری کرونا - وزارت بهداشت',
                    '2020-04-05',
                    NULL,
                    N'https://salamat.gov.ir',
                    ...
                    '2020-03-22',
                    NULL,
                    N'http://farsi.khamenei.ir/news-content?id=45225',
