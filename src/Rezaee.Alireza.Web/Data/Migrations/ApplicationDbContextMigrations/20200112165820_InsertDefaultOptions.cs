...
namespace AlirezaRezaee.PersonalNotes.WeblogApp.Data.Migrations.ApplicationDbContextMigrations
{
    public partial class InsertDefaultOptions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            INSERT INTO [Options] ([OptionName], [OptionValue]) VALUES(N'QuranAyah', N'" + HttpUtility.HtmlEncode("<div class=\"d-flex rounded-end justify-content-center align-items-center mx-auto mx-sm-0 mb-3 mb-sm-0\" style=\"width: 100px;\"><div class=\"text-center\" style=\"max-width: 100%;\"><div class=\"quran-logo mx-auto\"></div><div class=\"badge badge-secondary\">الصف - آیه ۱۳</div></div></div><div class=\"mx-auto px-2\"><div class=\"text-quran\">وَأُخْرَى تُحِبُّونَهَا <b style=\"color: #008000;\">نَصْرٌ مِنَ اللَّهِ وَفَتْحٌ قَرِيبٌ </b>وَبَشِّرِ الْمُؤْمِنِينَ</div><div class=\"mt-3\">و [رحمتى] ديگر كه آن را دوست داريد <b style=\"color: #008000;\">يارى و پيروزى نزديكى از جانب خداست </b>و مؤمنان را [بدان] بشارت ده</div></div>") + "')");
        }
