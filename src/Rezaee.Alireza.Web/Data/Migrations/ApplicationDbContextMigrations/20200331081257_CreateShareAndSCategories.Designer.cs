...
namespace AlirezaRezaee.PersonalNotes.WeblogApp.Data.Migrations.ApplicationDbContextMigrations
{
    ...
    [Migration("20200331081257_CreateShareAndSCategories")]
    partial class CreateShareAndSCategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ACategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ArticleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.SCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ShareCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ArticleCategory", b =>
                {
                    b.HasOne("AlirezaRezaee.PersonalNotes.WeblogApp.Models.Article", "Article")
                        .WithMany("ArticleCategories")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ACategory", "Category")
                        .WithMany("ArticleCategories")
            ...
            modelBuilder.Entity("AlirezaRezaee.PersonalNotes.WeblogApp.Models.ShareCategory", b =>
                {
                    ...
                    b.HasOne("AlirezaRezaee.PersonalNotes.WeblogApp.Models.SCategory", null)
                        .WithMany("ShareCategories")
                        .HasForeignKey("SCategoryId");

                    b.HasOne("AlirezaRezaee.PersonalNotes.WeblogApp.Models.Share", null)
                        .WithMany("ShareCategories")
